...
<body>
  ...
  <div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-4 text-uppercase text-white">Cart</h1>
        <a href="">Home</a>
  ...
  <center>
    <form>
      <h4 style="margin-left: -150px">Id :</h4>
      <input type="text" name="id" id="id" placeholder="Id" /><br /><br />
      <h4 style="margin-left: -70px">Product Id :</h4>
      <input type="text" name="proid" id="proid" placeholder="Product Id" /><br /><br />
      <h4 style="margin-left: -105px">User Id :</h4>
            ...
            <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
              ...
              <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Our
                  Services</a>
                <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Meet The
                  Team</a>
  ...
  <div class="container-fluid text-secondary py-4" style="background: #111111">
    <div class="container text-center">
      <p class="mb-0">
        &copy;
        <a class="text-white border-bottom" href="#">Your Site Name</a>. All
        Rights Reserved.
